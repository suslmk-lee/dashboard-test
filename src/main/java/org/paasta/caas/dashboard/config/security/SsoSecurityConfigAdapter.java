...
public class SsoSecurityConfigAdapter extends WebSecurityConfigurerAdapter {
	...
	@Configuration
    @Order(2)
    public static class saWebSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http               
                    .antMatcher("/caas/sa")
                    .authorizeRequests()
                    .antMatchers("/caas/sa").access("hasRole('ROLE_ADMIN')")
                    .antMatchers("/caas/sa" + "/**").authenticated()
                    
                    .and()
                    	.formLogin()
                    	.loginPage("/common/sa2login")
